...
DEFAULT_ACCESS_LOG_PATH = '/var/log/nginx/access.log'	# default path to nginx access log file
...
def info():
	...
	print('-------------------------------------------------------------------------------')
	print('Generate Summary for the nginx access log located at /var/log/nginx/access.log')
	print('For Streaming Data')
	print('$ nginxaccesslogparser --follow --input /var/log/nginx/access.log')
	print('-------------------------------------------------------------------------------')
